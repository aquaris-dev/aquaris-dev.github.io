...
<sup>[^1]</sup>: The 1489 users, listed as ‘Unknown’, are not included.
...
- Removed Double Tap 2 Wake vibration, as it caused random vibrations during a call.[^4]
...
- The proximity sensor does not properly work for direct calls.[^7]
- Some users have reported higher battery usage, compared to stock.[^8]
- Some users experience WLAN problems when phone switches from one router to another.-  we suspect it’s an issue with the Qualcomm Prima firmware. Contact us if you know more.[^9] 
